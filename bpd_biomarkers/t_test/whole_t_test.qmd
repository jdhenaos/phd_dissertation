...
pdf(file = "/home/rstudio/project/results/BPD/whole_t_test/240722_ttest_pco36_5.pdf",width = 6.35/2.54,height = 6.35/2.54)
...
pdf(file = "/home/rstudio/project/results/BPD/whole_t_test/240722_ttest_pco38_5.pdf",width = 6.35/2.54,height = 6.35/2.54)
plot(ggplot_gtable(boxp2))
dev.off()
...
proteomics$annotation <- converter(data = proteomics$annotation)
...
boxp2 <- ggplot_build(q)
boxp2$data[[3]]$annotation <- "adj. p-value= 0.014"
boxp2$data[[3]]$textsize <- 2.0

pdf(file = "/home/rstudio/project/results/BPD/whole_t_test/240722_ttest_ccl22.pdf",width = 6.35/2.54,height = 6.35/2.54)
plot(ggplot_gtable(boxp2))
dev.off()
