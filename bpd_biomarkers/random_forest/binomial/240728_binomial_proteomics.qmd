---
title: "Binary random forest using clinical and proteomics data"
author: Juan Henao
...
json.folder <- "/home/rstudio/project/input_data/random_forest/binomial/proteomics/"
...
ggsave(filename = "/home/rstudio/project/results/BPD/random_forest/binomial/proteomics/240728_rocauc.pdf",plot = p,
...
explanatory$Feature[1:6] <- c("CCL22",
                              "ERBB2",
                         "CST6",
                         "IGHM",
                         "SCGF-beta",
...
p <- ggplot(explanatory[1:6,],aes(x=Importance,y=Feature,fill=Feature)) +
  ...
  labs(title = "Feature importance (random forest)",
       subtitle = "Proteomics (reclassification)") +
  theme(text = element_text(size = 8), plot.title = element_text(size=8)) + theme(legend.position = "none")

ggsave(filename = "/home/rstudio/project/results/BPD/random_forest/binomial/proteomics/240728_feature_importance.pdf",plot = p,
