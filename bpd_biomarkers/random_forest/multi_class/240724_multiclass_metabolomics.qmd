---
title: "Multi-class random forest using clinical and metabolomics data"
author: Juan Henao
...
json.folder <- "/home/rstudio/project/input_data/random_forest/multiclass/metabolomics/"
...
ggsave(filename = "/home/rstudio/project/results/BPD/random_forest/multiclass/metabolomics/240728_rocauc.pdf",plot = p,
...
p <- ggplot(roc_data, aes(x = fpr, y = tpr,color=level)) +
  ...
  scale_linetype_manual(values=c(rep("solid",6))) +
  labs(title = "ROC AUC Random forest (Non-triglycerides)",
       subtitle = "No vs Mild vs Moderate/severe") +
  theme_classic()  + theme(text = element_text(size = 8), plot.title = element_text(size=8), legend.position = "none")

ggsave(filename = "/home/rstudio/project/results/BPD/random_forest/multiclass/metabolomics/240728_macro_rocauc.pdf",plot = p,
...
p <- ggplot(explanatory[1:6,],aes(x=Importance,y=Feature,fill=Feature)) +
  ...
  labs(title = "Feature importance (random forest)",
       subtitle = "Non-triglycerides (multi-class)") +
  theme(text = element_text(size = 8), plot.title = element_text(size=8)) + theme(legend.position = "none")

ggsave(filename = "/home/rstudio/project/results/BPD/random_forest/multiclass/metabolomics/240728_feature_importance.pdf",plot = p,
