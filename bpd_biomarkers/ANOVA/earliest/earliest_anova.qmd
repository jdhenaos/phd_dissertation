...
q <- ggplot(data = to.box.plot,aes(x=Condition, y=Expression,fill=Condition)) +
  ...
  labs(title = "PC(O-36:5) - ANOVA (adj. p-value= 0.01)",
...
pdf(file = "/home/rstudio/project/results/BPD/earliest_anova/240722_earliest_anova_pco36_5.pdf",width = 6.35/2.54,height = 6.35/2.54)
...
to.box.plot <- to.box.plot[to.box.plot$Protein == "PC(O-38:4)",]
to.box.plot$Condition <- as.factor(to.box.plot$Condition)
...
q <- ggplot(data = to.box.plot,aes(x=Condition, y=Expression,fill=Condition)) +
  ...
  scale_x_discrete(labels=c("No BPD", "Mild BPD", "Moderate/Severe BPD")) +
  xlab("") + ylab("Normalized abundances") +
  labs(title = "PC(O-38:4) - ANOVA (adj. p-value= 0.02)",
       subtitle = "t-test (post-hoc) - adj. p-values:") +
  stat_compare_means(method = "anova", label.y=-1)  + theme(legend.position = "none", text = element_text(size=8), plot.title = element_text(size=8)) +
  stat_compare_means(method = "t.test",comparisons = list(c("0","1"),
                                                          c("0","2"),
                                                          c("1","2")))
...
pdf(file = "/home/rstudio/project/results/BPD/earliest_anova/240722_earliest_anova_pco38_4.pdf",width = 6.35/2.54,height = 6.35/2.54)
plot(ggplot_gtable(boxp2))
dev.off()
...
to.box.plot <- to.box.plot[to.box.plot$Protein == "PC(40:4)",]
to.box.plot$Condition <- as.factor(to.box.plot$Condition)
...
q <- ggplot(data = to.box.plot,aes(x=Condition, y=Expression,fill=Condition)) +
  ...
  scale_x_discrete(labels=c("No BPD", "Mild BPD", "Moderate/Severe BPD")) +
  xlab("") + ylab("Normalized abundances") +
  labs(title = "PC(40:4) - ANOVA (adj. p-value= 0.03)",
       subtitle = "t-test (post-hoc) - adj. p-values:") +
  stat_compare_means(method = "anova", label.y=-1)  + theme(legend.position = "none", text = element_text(size=8), plot.title = element_text(size=8)) +
  stat_compare_means(method = "t.test",comparisons = list(c("0","1"),
                                                          c("0","2"),
...
pdf(file = "/home/rstudio/project/results/BPD/earliest_anova/240722_earliest_anova_pc40_4.pdf",width = 6.35/2.54,height = 6.35/2.54)
plot(ggplot_gtable(boxp2))
dev.off()
...
to.box.plot <- to.box.plot[to.box.plot$Protein == "PC(36:6)",]
to.box.plot$Condition <- as.factor(to.box.plot$Condition)
...
q <- ggplot(data = to.box.plot,aes(x=Condition, y=Expression,fill=Condition)) +
  ...
  scale_x_discrete(labels=c("No BPD", "Mild BPD", "Moderate/Severe BPD")) +
  xlab("") + ylab("Normalized abundances") +
  labs(title = "PC(36:6) - ANOVA (adj. p-value= 0.04)",
       subtitle = "t-test (post-hoc) - adj. p-values:") +
  stat_compare_means(method = "anova", label.y=-5)  + theme(legend.position = "none", text = element_text(size=8), plot.title = element_text(size=8)) +
  stat_compare_means(method = "t.test",comparisons = list(c("0","1"),
                                                          c("0","2"),
                                                          c("1","2")))
...
pdf(file = "/home/rstudio/project/results/BPD/earliest_anova/240722_earliest_anova_pc36_6.pdf",width = 6.35/2.54,height = 6.35/2.54)
plot(ggplot_gtable(boxp2))
dev.off()
...
to.box.plot <- to.box.plot[to.box.plot$Protein == "PC(O-36:4)",]
to.box.plot$Condition <- as.factor(to.box.plot$Condition)
...
q <- ggplot(data = to.box.plot,aes(x=Condition, y=Expression,fill=Condition)) +
  ...
  scale_x_discrete(labels=c("No BPD", "Mild BPD", "Moderate/Severe BPD")) +
  xlab("") + ylab("Normalized abundances") +
  labs(title = "PC(O-36:4) - ANOVA (adj. p-value= 0.04)",
       subtitle = "t-test (post-hoc) - adj. p-values:") +
  stat_compare_means(method = "anova", label.y=0.0)  + theme(legend.position = "none", text = element_text(size=8), plot.title = element_text(size=8)) +
  stat_compare_means(method = "t.test",comparisons = list(c("0","1"),
                                                          c("0","2"),
                                                          c("1","2")))
...
pdf(file = "/home/rstudio/project/results/BPD/earliest_anova/240722_earliest_anova_pco36_4.pdf",width = 6.35/2.54,height = 6.35/2.54)
plot(ggplot_gtable(boxp2))
dev.off()
...
q <- ggplot(data = to.box.plot,aes(x=Condition, y=Expression,fill=Condition)) +
  ...
  scale_x_discrete(labels=c("No BPD", "Mild BPD", "Moderate/Severe BPD")) +
  xlab("") + ylab("Normalized abundances") +
  labs(title = "CCL22 - ANOVA (adj. p-value= 0.004)",
       subtitle = "t-test (post-hoc) - adj. p-values:") +
...
pdf(file = "/home/rstudio/project/results/BPD/earliest_anova/240722_earliest_anova_ccl22.pdf",width = 6.35/2.54,height = 6.35/2.54)
plot(ggplot_gtable(boxp2))
dev.off()
