...
ggsave(paste0(file_dir,"so/noise_0_so_betweenness.pdf"), plot=p, width = 8.5, height = 5.5,device = "pdf",dpi=600, units="cm")

q <- p + theme(legend.position ="top")
ggsave(paste0(file_dir,"so/betweenness_scales.pdf"), plot=q, width = 8.5, height = 5.5,device = "pdf",dpi=600, units="cm")
```
...
ggsave(paste0(file_dir,"moran/noise_0_moran_betweenness.pdf"), plot=p, width = 8.5, height = 5.5,device = "pdf",dpi=600, units="cm")
```
...
ggsave(paste0(file_dir,"mos/noise_0_mos_betweenness.pdf"), plot=p, width = 8.5, height = 5.5,device = "pdf",dpi=600, units="cm")
```