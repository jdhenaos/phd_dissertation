...
```{r}
p <- enrichment_profile(pathways = AT.BP[1:10,],DEG = DEG.AT,color_down = "#ACD49F",color_up = "#008F00")
ggsave("output/figure1/unique_AT.pdf",plot=p,device="pdf",units="mm",dpi=600,width = 105,height = 60)
p
```
...
```{r}
p <- enrichment_profile(pathways = MFB.BP[1:10,],DEG = DEG.MFB,color_down = "#DF758C",color_up = "#E7298A")
ggsave("output/figure1/unique_FB.pdf",plot=p,device="pdf",units="mm",dpi=600,width = 105,height = 60)
p
```